          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
              ...
              <p className="text-lg font-light leading-relaxed mt-0 mb-4 text-blueGray-600">
                Our data collection services include surveys, interviews, focus
                groups, and observational studies, while our data entry services
                encompass cleaning, validation, migration, and database
                management. We offer customized solutions, timely delivery, and
              ...
              <div className="relative flex flex-col min-w-0 break-words w-full mb-2 shadow-lg rounded-lg bg-pink-500">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  <p className="text-md font-light mt-2 text-white">
                    At Excellent Research Consult, we are passionate about
                    research and dedicated to delivering high-quality results
