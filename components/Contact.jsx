              ...
              <div className="text-white lg:w-1/2 lg:mx-6">
                ...
                <div className="mt-6 md:mt-8">
                  ...
                  <div className="flex mt-4 -mx-1.5 ">
                    <a
                      className="mx-1.5 text-white transition-colors duration-300 transform hover:text-[#ff9900]"
                    ...
                    <a
                      className="mx-1.5 text-white transition-colors duration-300 transform hover:text-[#ff9900]"
                      href="https://instagram.com/excellent.research.consult?igshid=MzNlNGNkZWQ4Mg==" target="blank"
                    >
                      <svg
                        className="w-8 h-8"
                        viewBox="0 0 24 24"
