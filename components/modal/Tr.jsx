          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
              ...
              <p className="text-sm font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                We transform your audio and video content into accurate, well
                structured wriiten documents.
              </p>
              <p className="text-sm font-light leading-relaxed mt-0 mb-4 text-blueGray-600">
                We prioritize precision and quality in every transcription
                project as our rigorous quality control measures ensure that you
                receive accurate and error free transcripts, meeting the highest
                industry standards. We also upholds strict confidentiality
                protocols and takes comprehensive measures to safeguard your
                data throughout the transcription process.
              </p>
